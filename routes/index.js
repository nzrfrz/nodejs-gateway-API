    ...
    if (req.file !== undefined) {
        ...
        .then((results) => {
            ...
            if (results !== undefined && req.url.includes("v2")) {
                ...
                res.cookie("refreshToken", results.data.data.refreshToken, { httpOnly: true, secure: process.env.NODE_ENV === "production" ? true : false, sameSite: "lax", path: "/", domain: process.env.NODE_ENV === "production" ? undefined : ".vercel.app", maxAge: 24 * 60 * 60 * 1000 });
